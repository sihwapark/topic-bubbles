...
model = function(e) {
    ...
    S = function(e) {
        var i = String(e + 1);
        if (VIS.topic_labels && VIS.topic_labels[i]) {
            return VIS.topic_labels[i]
        }
        return "Topic" + " " + i
    };
    i.topic_label = S;
...
metadata.dfr = function(e) {
    ...
    n = function(e) {
        ...
        t.docs = d3.csv.parseRows(i, function(e, i) {
        		...
        		//Sihwa: a temporary fix for a list view error//
...
view.topic = function(e) {
    ...
    t.select("#topic_header").attr("value", e.label)
};
...
view.topic.docs = function(e) {
    ...
    var btn = d3.select("#topic_header_button");
    d3.select("#topic_header").on("click", function(e) {
    	btn.style("visibility", "visible");
    });


    btn.on("click", function(e) {
    	VIS.topic_labels[label_index + 1] = d3.select("#topic_header").node().value;
    	btn.style("visibility", "hidden");
    	//console.log(VIS.topic_labels)
    	//save to file
    	//reload
